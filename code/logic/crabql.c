...
static char *crabql_strdup(const char *source)
{
    size_t length;
    char *copy;
...
static void crabql_expression_error(
...
static bool crabql_is_space(char c)
{
    return isspace((unsigned char)c) != 0;
}

static const char *crabql_skip_space(const char *text)
{
    if (text == NULL)
    {
        return NULL;
...
static bool crabql_keyword_boundary(
    const char *position,
    const char *keyword)
{
    size_t length;
...
static void crabql_strip_semicolon(char *text)
{
    size_t length;
...
static fossil_db_crabql_status_t crabql_add_field(
    fossil_db_crabql_query_t *query,
    const char *field)
{
    char **fields;
...
static void crabql_free_fields(
    fossil_db_crabql_query_t *query)
{
    size_t i;
    if (query == NULL)
...
static fossil_db_crabql_argument_t *crabql_find_argument(
    fossil_db_crabql_query_t *query,
    const char *name)
{
    size_t i;
...
static void crabql_destroy_argument(
...
static void crabql_free_arguments(
    fossil_db_crabql_query_t *query)
{
    size_t i;
    if (query == NULL)
...
static fossil_db_crabql_query_type_t crabql_detect_type(
    const char *source)
{
    const char *cursor;
    if (source == NULL)
...
static fossil_db_crabql_status_t crabql_parse_select(
    fossil_db_crabql_query_t *query)
{
    const char *source;
    const char *from;
...
static fossil_db_crabql_status_t crabql_parse_table_command(
    fossil_db_crabql_query_t *query)
{
...
static fossil_db_crabql_status_t crabql_validate_query(
    fossil_db_crabql_query_t *query)
{
...
fossil_db_crabql_status_t fossil_db_crabql_parse(
    fossil_db_crabql_query_t **query,
    const char *source)
{
    fossil_db_crabql_status_t status;
...
fossil_db_crabql_query_type_t fossil_db_crabql_query_type(
...
const char *fossil_db_crabql_source(
    const fossil_db_crabql_query_t *query)
{
    if (query == NULL)
    {
...
fossil_db_crabql_status_t fossil_db_crabql_command(
    fossil_db_crabql_query_t *query,
    const char *command)
{
...
fossil_db_crabql_status_t fossil_db_crabql_select(
    fossil_db_crabql_query_t *query,
    const char *field)
{
...
fossil_db_crabql_status_t fossil_db_crabql_select_all(
    fossil_db_crabql_query_t *query)
{
    if (query == NULL)
    {
...
fossil_db_crabql_status_t fossil_db_crabql_where(
    fossil_db_crabql_query_t *query,
...
fossil_db_crabql_status_t fossil_db_crabql_order_by(
    fossil_db_crabql_query_t *query,
    const char *field)
{
...
fossil_db_crabql_status_t fossil_db_crabql_limit(
    fossil_db_crabql_query_t *query,
    size_t limit)
{
    if (query == NULL)
...
fossil_db_crabql_status_t fossil_db_crabql_kwarg(
    fossil_db_crabql_query_t *query,
    const char *name,
    fossil_db_crabdb_value_t *value)
{
...
bool fossil_db_crabql_has_kwarg(
    const fossil_db_crabql_query_t *query,
    const char *name)
{
    size_t i;
...
fossil_db_crabql_status_t fossil_db_crabql_remove_kwarg(
    fossil_db_crabql_query_t *query,
    const char *name)
{
    size_t i;
...
fossil_db_crabql_status_t fossil_db_crabql_expression_create(
    fossil_db_crabql_expression_t **expression,
    const char *source)
{
...
void fossil_db_crabql_expression_destroy(
    fossil_db_crabql_expression_t *expression)
{
    if (expression == NULL)
    {
...
fossil_db_crabql_status_t fossil_db_crabql_expression_validate(
    fossil_db_crabql_expression_t *expression)
{
    const char *cursor;
    int parentheses = 0;
...
const char *fossil_db_crabql_expression_source(
...
static fossil_db_crabql_status_t crabql_database_error(
    fossil_db_crabql_query_t *query,
...
static fossil_db_crabql_status_t crabql_execute_create(
    fossil_db_crabql_query_t *query,
...
static fossil_db_crabql_status_t crabql_execute_drop(
    fossil_db_crabql_query_t *query,
    fossil_db_crabdb_t *db)
{
    fossil_db_crabdb_status_t status;
...
static fossil_db_crabql_status_t crabql_execute_alter(
    fossil_db_crabql_query_t *query,
    fossil_db_crabdb_t *db)
{
    /*
...
static fossil_db_crabql_status_t crabql_execute_transaction(
    fossil_db_crabql_query_t *query,
    fossil_db_crabdb_t *db)
{
    fossil_db_crabdb_status_t status;
...
static fossil_db_crabql_status_t crabql_execute_record_query(
    fossil_db_crabql_query_t *query,
    fossil_db_crabdb_t *db)
{
    (void)db;
...
fossil_db_crabql_status_t fossil_db_crabql_execute(
    fossil_db_crabql_query_t *query,
    fossil_db_crabdb_t *db,
...
fossil_db_crabql_status_t fossil_db_crabql_run(
    fossil_db_crabdb_t *db,
    const char *source,
    fossil_db_crabql_result_t **result)
{
...
size_t fossil_db_crabql_result_count(
...
void fossil_db_crabql_result_destroy(
    fossil_db_crabql_result_t *result)
{
    free(result);
}
...
const char *fossil_db_crabql_status_string(
    fossil_db_crabql_status_t status)
{
    switch (status)
    {
...
const char *fossil_db_crabql_last_error(const fossil_db_crabql_query_t *query)
{
    if (query == NULL)
    {
        return NULL;
...
size_t fossil_db_crabql_error_line(
    const fossil_db_crabql_query_t *query)
{
...
size_t fossil_db_crabql_error_column(
    const fossil_db_crabql_query_t *query)
{
