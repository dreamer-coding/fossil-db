...
FOSSIL_TEST_GROUP(cpp_myshell_database_tests) {
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_open_create_close);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_commit_branch_checkout);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_errstr);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_put_get_del);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_put_all_types);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_put_invalid_type);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_get_not_found);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_get_buffer_too_small);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_del_not_found);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_del_twice);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_stage_unstage);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_backup_restore);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_open_invalid_path);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_create_existing_file);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_backup_restore_null_args);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_diff_null_args);
    FOSSIL_ADD_TEST(cpp_myshell_fixture, cpp_test_myshell_check_integrity_null);

    FOSSIL_ADD_SUITE(cpp_myshell_fixture);
} // end of tests
